...
As you can see, the MacBook Pro with M1 Max takes less than a minute to compute all 56 RAWs, while the device in second place - the iPad Pro - needs four times longer for the same task. For the old Surface Laptop is even a magnitude slower.
